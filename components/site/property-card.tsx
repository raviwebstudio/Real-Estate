    ...
    <article className="group panel overflow-hidden transition-transform duration-500 ease-out hover:-translate-y-1 hover:shadow-xl">
      <div className="relative aspect-[16/11] overflow-hidden">
        {heroImage ? (
          ...
          <Image
            src="/images/placeholders/m3m-golf-landscape.svg"
      ...
      <div className="space-y-4 p-6">
        ...
        <div className="flex flex-wrap gap-3 text-sm text-taupe">
          ...
          <span>•</span>
          <span>
            {property.variations.map((item) => item.label).join(", ")}
          </span>
          <span>•</span>
        ...
        <div className="flex items-center justify-between">
          <Link
            ...
            className="rounded-full border border-black/10 px-5 py-3 text-sm font-medium text-ink transition duration-300 ease-out hover:-translate-y-0.5 hover:bg-ink hover:text-white"
          >
            View Property
          </Link>
